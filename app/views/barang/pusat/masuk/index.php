<div class="card mb-4">
    <div class="card-body">
        <form action="/barang/pusat/masuk/tambah" method="POST">
            <div class="row">
                ...
                <?php if (!empty($barangMasuk)): 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/barang/pusat/masuk/hapus/<?= $bm['id_masuk'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus?')">Hapus</a>
                        </td>
                    </tr>
...
<script>
    function showEditModal(data) {
        ...
        document.getElementById('formEdit').action = '/barang/pusat/masuk/edit/' + data.id_masuk;
